...
#### 6월 30일 
 ...
 - 언리얼 블루프린트 개발(라이브 세션): 2일차 및 3일차 수업 진도를 따라잡았다.
  - 입력 데이터 중계에 대한 블루프린트: 
...
#### 7월 1일
    ...
    - C (라이브세션) : 포인터의 정의 활용법을 들으며 리마인딩 하였고, 더 나아가 포인터와 구조체 및 자료 구조에 대한 내용을 복기할 수 있었다.
    ...
    - 언리얼 블루프린트 개발(라이브 세션) : 효과음 설정, AI를 구현하고 해당 AI를 통한 몬스터 구현, UI를 화면에 추가하고 관리하는 방법 중 한 가지를 습득하였다.

    - 게임개발종합반(VOD): 1-9까지 진행했으며, 해당 내용을 통하여 액터에 애니메이션을 추가하고 재생하는 경험을 해보았다.
